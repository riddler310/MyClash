...
```txt
https://raw.githubusercontent.com/AIsouler/MyClash/refs/heads/main/Config/mihomoConfig.yaml
```

- [mihomoConfigLite.yaml（精简版）](/Config/mihomoConfigLite.yaml)

```txt
https://raw.githubusercontent.com/AIsouler/MyClash/refs/heads/main/Config/mihomoConfigLite.yaml
```
